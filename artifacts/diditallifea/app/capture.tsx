...
const styles = StyleSheet.create({
  ...
  preview: { marginHorizontal: 20, aspectRatio: PHOTO_ALIGNMENT_ASPECT_RATIO, borderRadius: 22, overflow: 'hidden', position: 'relative' },
  ...
  photoSaveButton: { position: 'absolute', top: 14, right: 14, zIndex: 10, borderRadius: 12, paddingHorizontal: 9, paddingVertical: 7, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5 },
  photoSaveText: { fontFamily: 'Inter_600SemiBold', fontSize: 11 },
  ...
  scaleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 20 },
  scaleControls: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  scaleValue: { width: 43, textAlign: 'center', fontFamily: 'Inter_700Bold', fontSize: 13 },
